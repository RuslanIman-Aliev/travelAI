...
export function SidebarLogo() {
  ...
  if (!mounted) {
    return (
      <div className="flex flex-col items-center gap-4 mb-10 px-2 mt-4">
  ...
  return (
    <div className="flex flex-col items-center gap-4 mb-10 px-2 mt-4 transition-all duration-500 ease-in-out">
      ...
      <div className="flex flex-col items-center text-center">
        <span className="font-bold text-2xl tracking-tight text-foreground bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70">
          TravelGuide
        </span>
